...
uint256 hashGenesisBlock("0x5408b20ad88b13acd77e283eb53568919080b27db8389a7f4f820cc8232005ba");
...
const string strMessageMagic = "stpatrickcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 5 * 60; // stpatrickcoin: 5 minutes 300 blocks
static const int64 nTargetSpacing = 30; // stpatrickcoin: 30 seconds blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal stpatrickcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "stpatrickcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "09/MAR/2015 Hands On With The Apple Watch, gadget, Apple";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1425938568; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1425938568;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8070094c528f7b4db83b170399a1df9cbaaf540ede509695c3737aef0ddfcc34"));
